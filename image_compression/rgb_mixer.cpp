...
{
  auto &data = *((const RGB_data * const)user_data);
...
static void ShowImage()
{
  ...
  createTrackbar(r_trackbar_name, window_name, &data.r_portion, 255, UpdateImage, (void*)&data);
  constexpr auto g_trackbar_name = "G portion";
  createTrackbar(g_trackbar_name, window_name, &data.g_portion, 255, UpdateImage, (void*)&data);
  constexpr auto b_trackbar_name = "B portion";
  createTrackbar(b_trackbar_name, window_name, &data.b_portion, 255, UpdateImage, (void*)&data);
