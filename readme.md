...
* [*OpenCV* 4.0.0](https://github.com/opencv/opencv/archive/4.0.0.zip) with the `viz` module, *QT* support, `pkg-config` support and non-free modules enabled as well as the [contributed modules](https://github.com/opencv/opencv_contrib/archive/4.0.0.zip) `xfeatures2d` and `sfm` included (see [recommended build command](opencv_config.md)),
